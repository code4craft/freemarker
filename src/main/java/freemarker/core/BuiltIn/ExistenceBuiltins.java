...
public class ExistenceBuiltins {
    ...
    public static class defaultBI extends ExistenceBuiltins.ExistenceBuiltIn {
    ...
    public static class existsBI extends ExistenceBuiltins.ExistenceBuiltIn {
    ...
    public static class has_contentBI extends ExistenceBuiltins.ExistenceBuiltIn {
        TemplateModel _eval(Environment env) throws TemplateException {
    ...
    public static class if_existsBI extends ExistenceBuiltins.ExistenceBuiltIn {
